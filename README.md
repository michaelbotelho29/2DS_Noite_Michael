...
•	Pico de Uso: Capacidade para suportar maior volume de acessos nos horários de pico e fins de semana.
  ...
  Login/CNPJ, Senha, Dados Bancários, Login das Redes Sociais
  e Telefone.

  o Pico de Uso:
  Seria razoável durante o horário de pico e maior número de
  acessos aos fins de semana. 
...
2- Proposta de Solução:
  Simularíamos para descobrir o limite do nosso sistema e usaríamos os dados para se adaptar a isso.
  Acompanharíamos o sistema em dias cruciais em tempo real para reagir a situações e desativar mecânicas secundarias, visando melhor desempenho.
